...
const std::set<std::string>& ContactManagersPluginFactory::getSearchPaths() const
{
  return plugin_loader_.search_paths;
}
...
const std::set<std::string>& ContactManagersPluginFactory::getSearchLibraries() const
{
