...
TEST(TesseractURDFUnit, parse_octree)  // NOLINT
{
...

  {
    std::string str = R"(<tesseract:octomap shape_type="box" prune="true">
                           <tesseract:octree filename="package://tesseract/support/meshes/box_2m.bt"/>
                         </tesseract:octomap>)";
    tesseract::geometry::Octree::Ptr geom;
    EXPECT_TRUE(runTest<tesseract::geometry::Octree::Ptr>(geom,
                                                          &tesseract::urdf::parseOctomap,
...
#ifdef TESSERACT_PARSE_POINT_CLOUDS
  {
    std::string str = R"(<tesseract:octomap shape_type="box">
                           <tesseract:point_cloud filename="package://tesseract/support/meshes/box_pcd.pcd" resolution="0.1"/>
                         </tesseract:octomap>)";
    tesseract::geometry::Octree::Ptr geom;
    EXPECT_TRUE(runTest<tesseract::geometry::Octree::Ptr>(geom,
                                                          &tesseract::urdf::parseOctomap,
  ...
  {  // Failure invalid resolution
    std::string str = R"(<tesseract:octomap shape_type="box">
                           <tesseract:point_cloud filename="package://tesseract/support/meshes/box_pcd.pcd" resolution="a"/>
                         </tesseract:octomap>)";
    tesseract::geometry::Octree::Ptr geom;
    EXPECT_FALSE(runTest<tesseract::geometry::Octree::Ptr>(geom,
                                                           &tesseract::urdf::parseOctomap,
  ...
  {  // Failure resource does not exist
    std::string str = R"(<tesseract:octomap shape_type="box">
                           <tesseract:point_cloud filename="package://tesseract/support/meshes/does_not_exist.pcd" resolution="0.1"/>
                         </tesseract:octomap>)";
    tesseract::geometry::Octree::Ptr geom;
    EXPECT_FALSE(runTest<tesseract::geometry::Octree::Ptr>(geom,
                                                           &tesseract::urdf::parseOctomap,
  ...
  {  // Failure resource is not a point cloud
    std::string str = R"(<tesseract:octomap shape_type="box">
                           <tesseract:point_cloud filename="package://tesseract/support/meshes/box_2m.bt" resolution="0.1"/>
                         </tesseract:octomap>)";
    tesseract::geometry::Octree::Ptr geom;
    EXPECT_FALSE(runTest<tesseract::geometry::Octree::Ptr>(geom,
                                                           &tesseract::urdf::parseOctomap,
