...
TEST(TesseractURDFUnit, parse_mesh)  // NOLINT
{
  ...
  {
    std::string str =
        R"(<mesh filename="package://tesseract/support/meshes/sphere_p25m.stl" scale="1 2 1" extra="0 0 0"/>)";
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/sphere_p25m.stl"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_TRUE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, true));
    EXPECT_TRUE(geom.size() == 1);
  ...
  {
    std::string str =
        R"(<mesh filename="package://tesseract/support/meshes/sphere_p25m.stl" tesseract:make_convex="false"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_TRUE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, true));
    EXPECT_TRUE(geom.size() == 1);
  ...
  {
    std::string str =
        R"(<mesh filename="package://tesseract/support/meshes/sphere_p25m.stl" tesseract:make_convex="true"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_TRUE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, true));
    EXPECT_TRUE(geom.size() == 1);
  ...
  {
    std::string str =
        R"(<mesh filename="package://tesseract/support/meshes/sphere_p25m.stl" tesseract:make_convex="foo"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/sphere_p25m.stl" scale="1 a 1"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, true));
    EXPECT_TRUE(geom.empty());
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/sphere_p25m.stl" scale="a 1 1"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, true));
    EXPECT_TRUE(geom.empty());
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/sphere_p25m.stl" scale="1 1 a"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, true));
    EXPECT_TRUE(geom.empty());
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/sphere_p25m.stl" scale="1 2 1 3"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, true));
    EXPECT_TRUE(geom.empty());
...
TEST(TesseractURDFUnit, parse_convex_mesh)  // NOLINT
{
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="1 2 1" extra="0 0 0"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_TRUE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
  ...
  {
    std::string str =
        R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="1 2 1" extra="0 0 0" tesseract:make_convex="true"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_TRUE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.size() == 1);
  ...
  {
    std::string str =
        R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="1 2 1" extra="0 0 0" tesseract:make_convex="false"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_TRUE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.size() == 1);
  ...
  {
    std::string str =
        R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="1 2 1" tesseract:make_convex="true"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_TRUE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.size() == 1);
  ...
  {
    std::string str =
        R"(<mesh filename="package://tesseract/support/meshes/box_box.dae" scale="1 2 1" tesseract:make_convex="true"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_TRUE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_TRUE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.size() == 1);
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="a 2 1" />)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.empty());
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="1 a 1" />)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.empty());
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="1 2 a" />)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.empty());
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="-1 2 1" />)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.empty());
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="1 -1 1" />)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.empty());
  ...
  {
    std::string str = R"(<mesh filename="package://tesseract/support/meshes/box_2m.ply" scale="1 2 1 3"/>)";
    std::vector<tesseract::geometry::PolygonMesh::Ptr> geom;
    EXPECT_FALSE(runTest<std::vector<tesseract::geometry::PolygonMesh::Ptr>>(
        geom, parse_mesh_fn, str, tesseract::urdf::MESH_ELEMENT_NAME.data(), resource_locator, false));
    EXPECT_TRUE(geom.empty());
