...
#include <tesseract/urdf/limits.h>
...
{
  {
    ...
    tesseract::scene_graph::JointLimits::Ptr elem;
    EXPECT_TRUE(runTest<tesseract::scene_graph::JointLimits::Ptr>(
        elem, &tesseract::urdf::parseLimits, str, tesseract::urdf::LIMITS_ELEMENT_NAME.data()));
...

  {
    ...
    tesseract::scene_graph::JointLimits::Ptr elem;
    EXPECT_FALSE(runTest<tesseract::scene_graph::JointLimits::Ptr>(
        elem, &tesseract::urdf::parseLimits, str, tesseract::urdf::LIMITS_ELEMENT_NAME.data()));
  }
...
{
  {
    tesseract::scene_graph::JointLimits::Ptr limits = std::make_shared<tesseract::scene_graph::JointLimits>();
    std::string text;
    EXPECT_EQ(0, writeTest<tesseract::scene_graph::JointLimits::Ptr>(limits, &tesseract::urdf::writeLimits, text));
  ...
  {
    tesseract::scene_graph::JointLimits::Ptr limits = nullptr;
    std::string text;
    EXPECT_EQ(1, writeTest<tesseract::scene_graph::JointLimits::Ptr>(limits, &tesseract::urdf::writeLimits, text));
    EXPECT_EQ(text, "");
  }
}
