...
TEST(EnvironmentCommandsSerializeUnit, AddTrajectoryLinkCommand)  // NOLINT
{
  ...
  trajectory.push_back(tesseract::common::JointState(std::vector<JointId>{ "j1", "j2" }, Eigen::VectorXd::Zero(2)));
  trajectory.push_back(tesseract::common::JointState(std::vector<JointId>{ "j1", "j2" }, Eigen::VectorXd::Ones(2)));
