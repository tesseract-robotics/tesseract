 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_MIMIC_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_MIMIC_H
...
inline tesseract_common::StatusCode::Ptr parse(JointMimic::Ptr& mimic, const tinyxml2::XMLElement* xml_element)
{
  mimic = nullptr;
  auto status_cat = std::make_shared<MimicStatusCategory>();

  JointMimic::Ptr m = std::make_shared<JointMimic>();
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_MIMIC_H
