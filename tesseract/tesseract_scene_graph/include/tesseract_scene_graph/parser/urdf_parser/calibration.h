 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_CALIBRATION_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_CALIBRATION_H
...
inline tesseract_common::StatusCode::Ptr parse(JointCalibration::Ptr& calibration, const tinyxml2::XMLElement* xml_element)
{
  calibration = nullptr;
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_CALIBRATION_H
