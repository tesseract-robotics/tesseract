 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_CAPSULE_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_CAPSULE_H
...
inline tesseract_common::StatusCode::Ptr parse(tesseract_geometry::Capsule::Ptr& capsule, const tinyxml2::XMLElement* xml_element)
{
  capsule = nullptr;
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_CAPSULE_H
