 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_CONVEX_MESH_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_CONVEX_MESH_H
                                               ...
                                               bool visual = true)
{
  ...
  if (visual)
    meshes = createMeshFromPath<tesseract_geometry::ConvexMesh>(locator(filename), scale, true, true);
  else
    meshes = createMeshFromPath<tesseract_geometry::ConvexMesh>(locator(filename), scale, false, false);
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_CONVEX_MESH_H
