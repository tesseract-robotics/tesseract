 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_CONE_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_CONE_H
...
inline tesseract_common::StatusCode::Ptr parse(tesseract_geometry::Cone::Ptr& cone, const tinyxml2::XMLElement* xml_element)
{
  cone = nullptr;
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_CONE_H
