 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_LIMITS_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_LIMITS_H
...
inline tesseract_common::StatusCode::Ptr parse(JointLimits::Ptr& limits, const tinyxml2::XMLElement* xml_element)
{
  limits = nullptr;

  tesseract_common::StatusCategory::Ptr status_cat = std::make_shared<LimitsStatusCategory>();
  JointLimits::Ptr l = std::make_shared<JointLimits>();
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_LIMITS_H
