 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_DYNAMICS_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_DYNAMICS_H
...
inline tesseract_common::StatusCode::Ptr parse(JointDynamics::Ptr& dynamics, const tinyxml2::XMLElement* xml_element)
{
  dynamics = nullptr;
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_DYNAMICS_H
