 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_INERTIAL_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_INERTIAL_H
...
inline tesseract_common::StatusCode::Ptr parse(Inertial::Ptr& inertial, const tinyxml2::XMLElement* xml_element)
{
  inertial = nullptr;
  auto status_cat = std::make_shared<InertialStatusCategory>();

  Inertial::Ptr i = std::make_shared<Inertial>();
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_INERTIAL_H
