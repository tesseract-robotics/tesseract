 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_MESH_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_MESH_H
                                               ...
                                               bool visual = true)
{
  ...
  if (visual)
    meshes = createMeshFromPath<tesseract_geometry::Mesh>(locator(filename), scale, true, true);
  else
    meshes = createMeshFromPath<tesseract_geometry::Mesh>(locator(filename), scale, true, false);
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_MESH_H
