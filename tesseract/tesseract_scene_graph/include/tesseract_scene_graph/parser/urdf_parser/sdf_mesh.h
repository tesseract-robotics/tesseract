 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_SDF_MESH_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_SDF_MESH_H
                                               ...
                                               bool visual = true)
{
  ...
  if (visual)
    meshes = createMeshFromPath<tesseract_geometry::SDFMesh>(locator(filename), scale, true, true);
  else
    meshes = createMeshFromPath<tesseract_geometry::SDFMesh>(locator(filename), scale, true, false);
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_SDF_MESH_H
