 ...
 */
#ifndef TESSERACT_SCENE_GRAPH_URDF_PARSER_COLLISION_H
#define TESSERACT_SCENE_GRAPH_URDF_PARSER_COLLISION_H
...
inline tesseract_common::StatusCode::Ptr parse(std::vector<Collision::Ptr>& collisions,
...
#endif // TESSERACT_SCENE_GRAPH_URDF_PARSER_COLLISION_H
