...
// clang-format off
  ...
  #ifdef __GNUC__
    #define TESSERACT_VISUALIZATION_IGNITION_PUBLIC __attribute__ ((dllexport))
    #define TESSERACT_VISUALIZATION_IGNITION_IMPORT __attribute__ ((dllimport))
  #else
    #define TESSERACT_VISUALIZATION_IGNITION_PUBLIC __declspec(dllexport)
    #define TESSERACT_VISUALIZATION_IGNITION_IMPORT __declspec(dllimport)
      ...
      #define TESSERACT_VISUALIZATION_IGNITION_PUBLIC TESSERACT_VISUALIZATION_IGNITION_PUBLIC
    #else
