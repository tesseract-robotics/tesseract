...
//      std::bind(&MotionPlannerProcessGenerator::process, this, task_inputs_.back(), start_instruction, end_instruction);
}
...
//      std::bind(&MotionPlannerProcessGenerator::conditionalProcess,
//                   this,
//                   task_inputs_.back(),
//                   start_instruction,
//                   end_instruction);
                                                      ...
                                                      const Instruction *end_instruction) const
{
  ...
  if (start_instruction && !isNullInstruction(*start_instruction))
  {
    // add start
  ...
  if (end_instruction && !isNullInstruction(*end_instruction))
  {
    // add end
