...
template class TESSERACT_MOTION_PLANNERS_DESCARTES_PUBLIC DescartesCollisionEdgeEvaluator<float>;
template class TESSERACT_MOTION_PLANNERS_DESCARTES_PUBLIC DescartesCollisionEdgeEvaluator<double>;
