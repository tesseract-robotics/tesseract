...
template class TESSERACT_MOTION_PLANNERS_DESCARTES_PUBLIC DescartesMotionPlanner<float>;
template class TESSERACT_MOTION_PLANNERS_DESCARTES_PUBLIC DescartesMotionPlanner<double>;
