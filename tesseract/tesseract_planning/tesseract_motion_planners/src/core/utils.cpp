...
CompositeInstruction SeedGenerator::processCompositeInstruction(const CompositeInstruction& /*instructions*/)
{
  ...
  // Note: I am commenting this out because this code will be obsolete in a few commits anyway.
  ...
  //            throw std::runtime_error("tesseract_planning::generateSeed: failed to find forward kinematics
  //            solution!");
  ...
  //        {
  //          // If both are joint waypoints it will calculate the forward kinematics for both then cartesian
  //          interpolate
