...
void SimplePlannerDefaultPlanProfile::apply()
{
  ...
  joint_cart_freespace = [this](const JointWaypoint& one,
                                ...
                                const PlannerRequest& four,
                                const ManipulatorInfo& five) {
    return fixedSizeAssignStateWaypoint(one, two, three, four, five, this->freespace_steps_);
  };
  ...
  joint_joint_linear = [this](const JointWaypoint& one,
                              ...
                              const PlannerRequest& four,
                              const ManipulatorInfo& five) {
    return fixedSizeInterpolateStateWaypoint(one, two, three, four, five, this->cartesian_steps_);
  };
  joint_cart_linear = [this](const JointWaypoint& one,
                             ...
                             const PlannerRequest& four,
                             const ManipulatorInfo& five) {
    return fixedSizeAssignStateWaypoint(one, two, three, four, five, this->cartesian_steps_);
  };
