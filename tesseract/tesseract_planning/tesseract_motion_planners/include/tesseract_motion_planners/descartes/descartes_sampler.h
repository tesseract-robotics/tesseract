 ...
 */
#ifndef TESSERACT_MOTION_PLANNERS_DESCARTES_SAMPLER_H
#define TESSERACT_MOTION_PLANNERS_DESCARTES_SAMPLER_H
...
class DescartesSampler : public descartes_light::PositionSampler<FloatType>
{
public:
  /**
   ...
   */
  DescartesSampler(const Eigen::Isometry3d tool_pose,
...
private:
  ...
  bool getBestSolution(std::vector<FloatType>& solution_set, const tesseract_common::VectorIsometry3d& tool_poses);
...
using DescartesSamplerF = DescartesSampler<float>;
using DescartesSamplerD = DescartesSampler<double>;

}  // namespace tesseract_motion_planners

#endif  // TESSERACT_MOTION_PLANNERS_DESCARTES_SAMPLER_H
