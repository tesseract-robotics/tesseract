/**
 * @file descartes_railed_sampler.h
 ...
 */
#ifndef TESSERACT_MOTION_PLANNERS_DESCARTES_RAILED_SAMPLER_H
#define TESSERACT_MOTION_PLANNERS_DESCARTES_RAILED_SAMPLER_H
...
class DescartesRailedSampler : public descartes_light::PositionSampler<FloatType>
{
public:
  /**
   * @brief This is a descartes sampler for a railed system + robot.
   *
   * The tip link name of the railed kinematics should match the base link name of the robot kinematics
   *
   ...
   * @param railed_kinematics The forward kinematics object for the railed system the robot is attached to
   ...
   * @param railed_sample_resolution The railed system sampling resolution
   ...
   */
  DescartesRailedSampler(const Eigen::Isometry3d tool_pose,
...
private:
  ...
  Eigen::Isometry3d world_to_railed_base_;
  Eigen::Matrix2d railed_limits_;
  Eigen::VectorXd railed_sample_resolution_;
...
using DescartesRailedSamplerF = DescartesRailedSampler<float>;
using DescartesRailedSamplerD = DescartesRailedSampler<double>;

}  // namespace tesseract_motion_planners
#endif  // TESSERACT_MOTION_PLANNERS_DESCARTES_RAILED_SAMPLER_H
