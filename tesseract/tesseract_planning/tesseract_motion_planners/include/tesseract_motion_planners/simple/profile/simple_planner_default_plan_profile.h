...
#ifndef TESSERACT_MOTION_PLANNERS_SIMPLE_DEFAULT_PLAN_PROFILE_H
#define TESSERACT_MOTION_PLANNERS_SIMPLE_DEFAULT_PLAN_PROFILE_H
...
#ifdef SWIG
%shared_ptr(tesseract_planning::SimplePlannerDefaultPlanProfile)
#endif  // SWIG
...
public:
  ...
  using ConstPtr = std::shared_ptr<const SimplePlannerDefaultPlanProfile>;

  SimplePlannerDefaultPlanProfile(int freespace_steps = 10, int cartesian_steps = 10);
