#ifndef ARIS_PROCESS_PLANNERS_PROCESS_DEFINITION_GENERATOR_H
#define ARIS_PROCESS_PLANNERS_PROCESS_DEFINITION_GENERATOR_H
...
#endif  // ARIS_PROCESS_PLANNERS_PROCESS_DEFINITION_GENERATOR_H
