...
macro(tesseract_target_compile_options target)
  ...
  if (ARG_INTERFACE)
    if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
      ...
      target_compile_definitions(${target} INTERFACE TESSERACT_BUILDING_LIBRARY=ON)
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
      target_compile_definitions(${target} INTERFACE _USE_MATH_DEFINES=ON TESSERACT_BUILDING_LIBRARY=ON)
    else()
  ...
  elseif(ARG_PUBLIC)
    ...
    if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
      ...
      target_compile_definitions(${target} PRIVATE TESSERACT_BUILDING_LIBRARY=ON)
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
  ...
  elseif(ARG_PRIVATE)
    if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
      ...
      target_compile_definitions(${target} PRIVATE TESSERACT_BUILDING_LIBRARY=ON)
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
      target_compile_definitions(${target} PRIVATE _USE_MATH_DEFINES=ON TESSERACT_BUILDING_LIBRARY=ON)
    else()
      message(WARNING "Non-GNU compiler detected. If using AVX instructions, Eigen alignment issues may result.")
    endif()
  endif()
