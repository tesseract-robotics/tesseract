...
{
class TESSERACT_PUBLIC URDFStatusCategory : public tesseract_common::StatusCategory
{
public:
 ...
 * @return Status Code
 */
tesseract_common::StatusCode::Ptr TESSERACT_PUBLIC
 ...
 */
tesseract_scene_graph::SceneGraph::Ptr TESSERACT_PUBLIC
