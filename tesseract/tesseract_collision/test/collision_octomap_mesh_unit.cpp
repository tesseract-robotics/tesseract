...
TEST(TesseractCollisionUnit, BulletDiscreteSimpleCollisionOctomapSphereMeshUnit)  // NOLINT
{
  ...
  test_suite::runTest(checker, "/tmp/BulletDiscreteSimpleCollisionOctomapSphereMeshUnit.ply");
}

TEST(TesseractCollisionUnit, BulletDiscreteBVHCollisionOctomapSphereMeshUnit)  // NOLINT
{
  tesseract_collision_bullet::BulletDiscreteBVHManager checker;
  test_suite::runTest(checker, "/tmp/BulletDiscreteBVHCollisionOctomapSphereMeshUnit.ply");
}
...
//  test_suite::runTest(checker, "/tmp/FCLDiscreteBVHCollisionOctomapSphereMeshUnit.ply");  // TODO: There appears to be
//  an issue in fcl for octomap::OcTree.
//}
