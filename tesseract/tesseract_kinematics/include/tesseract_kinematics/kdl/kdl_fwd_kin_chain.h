...
public:
   ...
   */
  KDLFwdKinChain(tesseract_scene_graph::SceneGraph::ConstPtr scene_graph,
  ...
  virtual ~KDLFwdKinChain() = default;
  KDLFwdKinChain(const KDLFwdKinChain&);
  KDLFwdKinChain& operator=(const KDLFwdKinChain&);
  KDLFwdKinChain(KDLFwdKinChain&&) noexcept;
  KDLFwdKinChain& operator=(KDLFwdKinChain&&) noexcept;
  ...
  unsigned int numJoints() const { return kdl_data_.robot_chain.getNrOfJoints(); }
  const std::string& getBaseLinkName() const { return kdl_data_.base_name; }
