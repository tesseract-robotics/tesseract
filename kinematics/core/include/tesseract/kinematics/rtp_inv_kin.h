 ...
 * getTipLinkIds() is the tool chain tip (i.e. the frame the target pose is for).
...
public:
   ...
   * @throws std::out_of_range if @p tip_link_poses has no entry for getTipLinkIds()[0]. That is
