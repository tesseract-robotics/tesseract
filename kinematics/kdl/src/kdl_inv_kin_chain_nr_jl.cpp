...
void KDLInvKinChainNR_JL::calcInvKinHelper(IKSolutions& solutions,
...
tesseract::common::LinkId KDLInvKinChainNR_JL::getWorkingFrameId() const { return kdl_data_.base_link_id; }
