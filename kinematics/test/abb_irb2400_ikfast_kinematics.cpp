...
TESSERACT_SCHEMA_REGISTER(AbbIRB2400Kinematics, ikFastInvKinSchema);
TESSERACT_SCHEMA_REGISTER_DERIVED_TYPE(tesseract::kinematics::InvKinFactory, AbbIRB2400Kinematics);
