...
`tesseract_kinematics_rtp_vs_kdl_nr_jl_benchmark` compares `RTPInvKin`
...
. install/setup.bash
./build/tesseract/kinematics/test/benchmarks/tesseract_kinematics_rtp_vs_kdl_nr_jl_benchmark \
