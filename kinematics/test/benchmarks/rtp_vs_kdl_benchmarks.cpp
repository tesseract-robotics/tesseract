...
const tesseract::common::LinkId& TOOL_TIP_LINK = ABB_TOOL_TIP_LINK;  // NOLINT(cert-err58-cpp)
                     ...
                     const tesseract::common::KinematicLimits& limits)
{
  ...
  tesseract::common::LinkIdTransformMap fwd;
...
struct Target
{
  tesseract::common::LinkIdTransformMap tip_link_poses;  ///< keyed by TOOL_TIP_LINK
...
Fixture makeFixture()
{
  ...
  auto limits = getTargetLimits(*sg, full_fk->getJointIds());
