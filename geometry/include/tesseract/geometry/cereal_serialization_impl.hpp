...
CEREAL_REGISTER_TYPE(tesseract::geometry::SignedDistanceField)
...
CEREAL_REGISTER_POLYMORPHIC_RELATION(tesseract::geometry::Geometry, tesseract::geometry::SignedDistanceField)
