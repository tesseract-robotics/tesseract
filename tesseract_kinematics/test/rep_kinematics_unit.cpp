...
{
  return std::make_unique<KDLFwdKinChain>("robot_external_positioner", scene_graph, "positioner_tool0", "tool0");
}
...
InverseKinematics::UPtr getFullInvKinematics(const tesseract_scene_graph::SceneGraph& scene_graph)
{
  ...
  auto rep_inv_kin = std::make_unique<REPInvKin>("robot_external_positioner",
                                                 scene_graph,
                                                 scene_state,
                                                 opw_kin->clone(),
                                                 2.5,
