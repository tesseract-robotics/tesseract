...
const static URParameters UR10eParameters(0.181, -0.613, -0.571, 0.135, 0.120, 0.117);

/** @brief The UR5e kinematic parameters */
const static URParameters UR5eParameters(0.163, -0.425, -0.392, 0.127, 0.100, 0.100);

/** @brief The UR3e kinematic parameters */
const static URParameters UR3eParameters(0.152, -0.244, -0.213, 0.104, 0.085, 0.092);
