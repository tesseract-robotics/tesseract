...
tesseract::scene_graph::SceneGraph::Ptr getABBSceneGraph(ABBConfig config = ABBConfig::ROBOT_ONLY)
{
  ...
  if (config == ABBConfig::ROBOT_ON_RAIL)
  {
    ...
    joint_a.parent_link_id = LinkId("world");
    joint_a.child_link_id = LinkId("axis_1");
    ...
    joint_b.parent_link_id = LinkId("axis_1");
    joint_b.child_link_id = LinkId("axis_2");
    ...
    joint_c.parent_link_id = LinkId("axis_1");
    joint_c.child_link_id = LinkId("base_link");
  ...
  else if (config == ABBConfig::ROBOT_WITH_POSITIONER)
  {
    ...
    Joint joint_c("joint_base_link");
    joint_c.parent_link_id = LinkId("world");
    joint_c.child_link_id = LinkId("base_link");
    joint_c.type = JointType::FIXED;
    EXPECT_TRUE(g->addJoint(joint_c));
  }
  ...
  joint_tool0.parent_link_id = LinkId("link_6");
...
TEST(TesseractSRDFUnit, TesseractSRDFModelUnit)  // NOLINT
{
  ...
  joint_state[tesseract::common::JointId("joint_1")] = 0;
  joint_state[tesseract::common::JointId("joint_2")] = 0;
  joint_state[tesseract::common::JointId("joint_3")] = 0;
  joint_state[tesseract::common::JointId("joint_4")] = 0;
  ...
  group_tcps["manipulator_chain"][tesseract::common::LinkId("laser")] = Eigen::Isometry3d::Identity();
  group_tcps["manipulator_joint"][tesseract::common::LinkId("laser")] = Eigen::Isometry3d::Identity();
  group_tcps["manipulator_link"][tesseract::common::LinkId("laser")] = Eigen::Isometry3d::Identity();
...
TEST(TesseractSRDFUnit, LoadSRDFSaveUnit)  // NOLINT
{
  ...
  EXPECT_TRUE(tcp_it->second.find(tesseract::common::LinkId("laser")) != tcp_it->second.end());
  EXPECT_TRUE(tcp_it->second.find(tesseract::common::LinkId("welder")) != tcp_it->second.end());
...
TEST(TesseractSRDFUnit, LoadSRDFGroupStatesUnit)  // NOLINT
{
  ...
  EXPECT_DOUBLE_EQ(it2->second.at(tesseract::common::JointId("joint_1")), 0);
  EXPECT_DOUBLE_EQ(it2->second.at(tesseract::common::JointId("joint_2")), 0);
  EXPECT_DOUBLE_EQ(it2->second.at(tesseract::common::JointId("joint_3")), 0);
  EXPECT_DOUBLE_EQ(it2->second.at(tesseract::common::JointId("joint_4")), 0);
  EXPECT_DOUBLE_EQ(it2->second.at(tesseract::common::JointId("joint_5")), 0);
  EXPECT_DOUBLE_EQ(it2->second.at(tesseract::common::JointId("joint_6")), 0);
...
TEST(TesseractSRDFUnit, SRDFGroupTCPsUnit)  // NOLINT
{
  ...
  auto it2 = it->second.find(tesseract::common::LinkId("laser"));
  EXPECT_TRUE(it2 != it->second.end());

  auto it3 = it->second.find(tesseract::common::LinkId("welder"));
...
TEST(TesseractSRDFUnit, AddRemoveGroupJointStateUnit)  // NOLINT
{
  ...
  group_states[tesseract::common::JointId("joint_1")] = 0;
  group_states[tesseract::common::JointId("joint_2")] = 0;
  group_states[tesseract::common::JointId("joint_3")] = 0;
  group_states[tesseract::common::JointId("joint_4")] = 0;
  group_states[tesseract::common::JointId("joint_5")] = 0;
  group_states[tesseract::common::JointId("joint_6")] = 0;
  ...
  // Not Equal
  group_states[tesseract::common::JointId("joint_1")] = 1;
  group_states[tesseract::common::JointId("joint_2")] = 2;
  group_states[tesseract::common::JointId("joint_3")] = 3;
  group_states[tesseract::common::JointId("joint_4")] = 4;
  group_states[tesseract::common::JointId("joint_5")] = 5;
  group_states[tesseract::common::JointId("joint_6")] = 6;
...
TEST(TesseractSRDFUnit, AddRemoveGroupTCPUnit)  // NOLINT
{
  ...
  EXPECT_TRUE(
      info.group_tcps.at("manipulator").at(tesseract::common::LinkId("laser")).isApprox(tcp_laser, 1e-6));
  EXPECT_TRUE(
      info.group_tcps.at("manipulator").at(tesseract::common::LinkId("welder")).isApprox(tcp_welder, 1e-6));
