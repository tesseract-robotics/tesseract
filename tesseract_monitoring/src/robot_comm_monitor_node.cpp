...
public:
  FanucCommError(ros::NodeHandle& nh)
  {
    ...
    chatter_sub=nh.subscribe("joint_states",20,&FanucCommError::subscriberCallback,this);

  }
  void startTimer()
  {
    timer = FanucCommError::nh.createTimer(ros::Duration(error_timer),&FanucCommError::timerCallback, this);
  }
  ...
  void timerCallback(const ros::TimerEvent&)
  {
    ...
    //ROS_INFO("FANUC COM ERROR= %s \n", fanuc_comm_error.data ? "true" : "false");//debugging statement
  }
