      ...
      .beginOneOf()
        ...
        .container("by_params")
          .container("params").required()
            .float64("d1").required().doc("DH parameter d1").done()
            .float64("a2").required().doc("DH parameter a2").done()
            .float64("a3").required().doc("DH parameter a3").done()
            .float64("d4").required().doc("DH parameter d4").done()
            .float64("d5").required().doc("DH parameter d5").done()
            .float64("d6").required().doc("DH parameter d6").done()
          .done()
        .done()
      .endOneOf()
      .build();
