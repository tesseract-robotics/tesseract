...
{
  {
    ...
    EXPECT_TRUE(runTest<tesseract_geometry::Capsule::Ptr>(
        geom, &tesseract_urdf::parseCapsule, str, tesseract_urdf::CAPSULE_ELEMENT_NAME.data()));
  ...
  //    tesseract_geometry::Capsule::Ptr geom;
  //    auto status = runTest<tesseract_geometry::Capsule::Ptr>(geom, str, tesseract_urdf::CAPSULE_ELEMENT_NAME.data());
  //    EXPECT_FALSE(*status);
