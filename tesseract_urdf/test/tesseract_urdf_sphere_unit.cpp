...
{
  {
    ...
    EXPECT_TRUE(runTest<tesseract_geometry::Sphere::Ptr>(
        geom, &tesseract_urdf::parseSphere, str, tesseract_urdf::SPHERE_ELEMENT_NAME));
  ...
  //    tesseract_geometry::Sphere::Ptr geom;
  //    auto status = runTest<tesseract_geometry::Sphere::Ptr>(geom, str, tesseract_urdf::SPHERE_ELEMENT_NAME);
  //    EXPECT_FALSE(*status);
