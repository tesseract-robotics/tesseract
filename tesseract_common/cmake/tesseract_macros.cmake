...
macro(tesseract_cpack)
  ...
  if(UNIX)
    ...
    set(CPACK_PACKAGE_FILE_NAME
        "${TESSERACT_PACKAGE_PREFIX}${TESSERACT_PACKAGE_NAME}_${DEB_ARCH}_linux_${ARG_VERSION}")
    ...
    string(REPLACE ";" "," CPACK_DEBIAN_PACKAGE_DEPENDS "${ARG_LINUX_DEPENDS}")
  elseif(WIN32)
    ...
    string(REPLACE ";" "," CPACK_NUGET_PACKAGE_DEPENDENCIES "${ARG_WINDOWS_DEPENDS}")
  endif()
  include(CPack)
endmacro()
