...
if(TinyXML2_FOUND)
  ...
  if(NOT TINYXML2_LIBRARY)
    # in this case, we're probably using TinyXML2 version 5.0.0 or greater in which case tinyxml2 is an exported target
    ...
    if(NOT TARGET tinyxml2::tinyxml2)
      # TINYXML2_LIBRARY is composed of debug;<path\to\debug.lib>;optimized;<path\to\release.lib> we have to extract the
      # appropriate component based on the current configuration.
      list(LENGTH TINYXML2_LIBRARY TINYXML_LIBRARY_LIST_LENGTH)
      if(NOT
         ${TINYXML_LIBRARY_LIST_LENGTH}
         EQUAL
         4)
