...
AddKinematicsInformationCommand::AddKinematicsInformationCommand(tesseract_srdf::KinematicsInformation kinematics_information)
  : Command(CommandType::ADD_KINEMATICS_INFORMATION), kinematics_information_(std::move(kinematics_information))
{
}

const tesseract_srdf::KinematicsInformation& AddKinematicsInformationCommand::getKinematicsInformation() const { return kinematics_information_; }
