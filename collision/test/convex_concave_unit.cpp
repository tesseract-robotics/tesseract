...
#include "tesseract/collision/bullet/bullet_contact_checker.h"
...
TEST(TesseractConvexConcaveUnit, ConvexConcaveUnit)
{
  ...
  tesseract::CollisionShapePtr sphere(shapes::createMeshFromResource("package://tesseract/collision/test/sphere.stl"));
