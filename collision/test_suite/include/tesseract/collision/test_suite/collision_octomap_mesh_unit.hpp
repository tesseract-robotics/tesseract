...
inline void addCollisionObjects(DiscreteContactManager& checker)
{
  ...
  /////////////////////////////////////////////////////////////////
  CollisionShapePtr sphere = tesseract::geometry::createMeshFromPath<tesseract::geometry::Mesh>(
      locator.locateResource("package://tesseract/support/meshes/plane_4m.stl")->getFilePath(),
