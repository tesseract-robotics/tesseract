/**
 * @file puzzle_piece_dual_robot_example.cpp
 * @brief Puzzle piece dual robot implementation
 *
...
#include <tesseract_ros_examples/puzzle_piece_dual_robot_example.h>
...
{
tesseract_common::VectorIsometry3d PuzzlePieceDualRobotExample::makePuzzleToolPoses()
{
...
ProblemConstructionInfo PuzzlePieceDualRobotExample::cppMethod()
{
...
bool PuzzlePieceAuxillaryAxesExample::run()
{
  ...
  collisions.clear();
  bool found =
      checkTrajectory(*manager, *state_solver, prob->GetKin()->getJointNames(), prob->GetInitTraj(), collisions);
